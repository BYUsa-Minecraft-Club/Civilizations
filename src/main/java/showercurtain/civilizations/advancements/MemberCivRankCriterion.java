...
public class MemberCivRankCriterion extends AbstractCriterion<MemberCivRankCriterion.Condition> {
    public static final Identifier ID = new Identifier("civilizations","member_civ_rank");
