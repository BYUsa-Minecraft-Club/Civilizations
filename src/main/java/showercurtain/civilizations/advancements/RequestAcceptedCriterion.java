...
public class RequestAcceptedCriterion extends AbstractCriterion<RequestAcceptedCriterion.Condition> {
    public static final Identifier ID = new Identifier("civilizations","request_accepted");
